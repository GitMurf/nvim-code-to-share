...
local function MDWA_update_virtual_text()
  ...
  local text = string.format('MDWA Mode: %02d:%02d | Inactivity: %d', minutes, seconds, inactivity_seconds)
  ...
  local filled_blocks = math.floor((mdwa_duration - mdwa_remaining_time) / mdwa_duration * total_blocks)
  local progress_bar = string.rep('█', filled_blocks) .. string.rep('░', total_blocks - filled_blocks)
